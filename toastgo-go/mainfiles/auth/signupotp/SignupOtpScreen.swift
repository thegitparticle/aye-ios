...
struct SignupOtpScreen: View {
	
	@StateObject private var viewModel = SignupOtpViewModel()
	...
	@ObservedObject var textFieldManager = TextFieldManagerSignUpOtp()
...
class TextFieldManagerSignUpOtp: ObservableObject {
