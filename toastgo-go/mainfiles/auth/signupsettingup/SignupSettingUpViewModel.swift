//
//  SignupSettingUpViewModel.swift
//  toastgo-go
//
...
class SignupSettingUpViewModel: ObservableObject {
	
	@Published var contactsSycned: String = ""
	
	public func postOtpToServerSignup(userid: String, countryCode: String, contactsList: [Any]) {
