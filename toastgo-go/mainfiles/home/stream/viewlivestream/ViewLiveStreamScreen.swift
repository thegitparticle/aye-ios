...
struct ViewLiveStreamScreen: View {
    
	@StateObject private var viewModel = ViewLiveStreamViewModel()
	...
	let localCanvas = ViewLiveStreamVideoCanvas()
	let remoteCanvas = ViewLiveStreamVideoCanvas()
	
	private let videoEngine = ViewLiveStreamVideoEngine()
...
extension ViewLiveStreamScreen {
	func log(content: String) {
		print(content)
	}
}

fileprivate extension ViewLiveStreamScreen {
...
//struct ViewLiveStreamScreen_Previews: PreviewProvider {
//    static var previews: some View {
//        ViewLiveStreamScreen()
//    }
//}
