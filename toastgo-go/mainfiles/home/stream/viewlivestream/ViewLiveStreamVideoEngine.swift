//
//  ViewLiveStreamVideoEngine.swift
//  toastgo-go
//
...
class ViewLiveStreamVideoEngine: NSObject {
	
	// init AgoraRtcEngineKit
	lazy var agoraEngine = AgoraRtcEngineKit.sharedEngine(withAppId: "851193d91b1945bda153a38f3584ead3", delegate: self)
	var contentView: ViewLiveStreamScreen?
	
}


extension ViewLiveStreamVideoEngine: AgoraRtcEngineDelegate {
