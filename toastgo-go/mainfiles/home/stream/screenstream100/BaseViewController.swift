...
extension AGEVideoContainer {
	...
	func layoutStream1x2(views: [UIView]) {
		let count = views.count
	...
	func layoutStream2x1(views: [UIView]) {
		let count = views.count
	...
	func layoutStream2x2(views: [UIView]) {
		let count = views.count
	...
	func layoutStream3x2(views: [UIView]) {
		let count = views.count
	...
	func layoutStream3x3(views: [UIView]) {
		let count = views.count
